...
// //    設定標籤被選取時add class , 其他標籤remove class
//   $("#roseBtn").addClass("label_checked");
//   $(".label>div>button").not("#roseBtn").removeClass("label_checked");
// }

// function eustomaBtn(){
//     document.getElementById("mainTitle").innerText="桔梗花";
...
//   //    設定標籤被選取時add class , 其他標籤remove class
//   $("#eustomaBtn").addClass("label_checked");
//   $(".label>div>button").not("#eustomaBtn").removeClass("label_checked");
// }
...
//    //    設定標籤被選取時add class , 其他標籤remove class
//   $("#hydrangeasBtn").addClass("label_checked");
//   $(".label>div>button").not("#hydrangeasBtn").removeClass("label_checked");
// }
...
//    //    設定標籤被選取時add class , 其他標籤remove class
//   $("#lilyBtn").addClass("label_checked");
//   $(".label>div>button").not("#lilyBtn").removeClass("label_checked");
// }
...
//    //    設定標籤被選取時add class , 其他標籤remove class
//   $("#orchidBtn").addClass("label_checked");
//   $(".label>div>button").not("#orchidBtn").removeClass("label_checked");
// }
